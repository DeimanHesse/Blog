    ...
    return (
        <div className="main">
           ...
           {isAuth ? 
            ...
            <div className="filterBtn" style={{textAlign: "center", marginBottom: 30}}>
                <button onClick={(e) =>sort(e)} value="Политика">Политика</button>
                <button onClick={(e) =>sort(e)} value="Искусство">Искусство</button>
                <button onClick={(e) =>sort(e)} value="Технологии">Технологии</button>
                <button onClick={(e) =>sort(e)} value="Все" >Все</button>
